...
```text
执行 docs/orchestration-scenarios/02-team-consensus/README.md「场景 4」的完整闭环并自动评判（挑战级，6 成员 × max_rounds=5，预计 ~35 min）。
...
6. 运行：bun docs/orchestration-scenarios/02-team-consensus/check-math-factoring-consensus.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
