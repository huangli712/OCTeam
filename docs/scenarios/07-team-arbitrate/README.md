...
```text
执行 docs/scenarios/07-team-arbitrate/README.md「场景 1」的完整闭环并自动评判。
...
6. 运行：bun docs/scenarios/07-team-arbitrate/check-math-matrix-inverse.ts <run_dir>
...
```text
执行 docs/scenarios/07-team-arbitrate/README.md「场景 2」的完整闭环并自动评判。
...
5. 定位 <run_dir>
6. 运行：bun docs/scenarios/07-team-arbitrate/check-physics-stiff-ode.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
...
```text
执行 docs/scenarios/07-team-arbitrate/README.md「场景 3」的完整闭环并自动评判。
...
4. team_results 轮询至 master 收到汇总
5. 定位 <run_dir>
6. 运行：bun docs/scenarios/07-team-arbitrate/check-coding-cache-eviction.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
...
```text
执行 docs/scenarios/07-team-arbitrate/README.md「场景 4」的完整闭环并自动评判。
...
6. 运行：bun docs/scenarios/07-team-arbitrate/check-physics-pde-arbitrate.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
