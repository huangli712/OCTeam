/**
 * Per-mode re-dispatch entry for team_resume's Phase 3 (called by
 * tools/control/resume.ts). The dispatcher (resumeDispatch) routes to the
 * per-mode resume handlers for the 12 orchestration modes and their shared
