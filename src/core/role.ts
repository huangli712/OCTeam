...
export const ROLES: Record<string, RoleDef> = {
    ...
    debugger: {
        ...
        instruction: [
            ...
            "",
            "## Workflow",
            "1. Reproduce the issue → confirmed reproduction",
            ...
            "5. Lock the fix with a regression test → regression test",
    ...
    optimizer: {
        ...
        instruction: [
            ...
            "",
            "## Workflow",
            "1. Profile to find real hotspots → identified bottlenecks with data",
            "2. Improve algorithms, memory, or I/O → optimized code",
            "3. Verify behavior preserved with before/after numbers → comparison metrics",
    ...
    tester: {
        ...
        instruction: [
            ...
            "4. Report defects back to the implementer → defect list",
            "",
            "## Rules",
    ...
    reviewer: {
        ...
        instruction: [
            ...
            "2. Check correctness, security, conventions, edge cases → issue list with file:line + risk",
    ...
    architect: {
        ...
        instruction: [
            ...
            "2. Design module boundaries, data flow, interfaces, trade-offs → design document",
            "3. Identify risks and alternatives → risk list with mitigations",
    ...
    writer: {
        ...
        instruction: [
            ...
            "",
            "## Rules",
            "- Keep documentation accurate, concise, and example-driven",
        ].join("\n"),
    },
    solver: {
        agent: "oct-deep",
        instruction: [
            ...
            "",
            "## Rules",
            "- Take on tasks that exceed single-step execution — if a problem is simple enough for one step, flag it for downgrading to coder",
        ].join("\n"),
    },
    ...
    mathematician: {
        ...
        instruction: [
            ...
            "2. Derive step by step, justifying every step → derivation",
    ...
    physicist: {
        ...
        instruction: [
            ...
            "",
            "## Workflow",
            "1. Build the physical model → model setup",
    ...
    simulator: {
        ...
        instruction: [
            ...
            "",
            "## Rules",
            "- Report numerical accuracy and limitations honestly",
        ].join("\n"),
    },
    chemist: {
        agent: "oct-junior",
        instruction: [
            ...
            "2. Analyze: reaction mechanisms, structure, bonding, properties → analysis",
            "3. Apply computational methods where useful → computational results",
            "4. Report conclusions → findings",
            "",
            "## Rules",
            "- Ground conclusions in chemical principles",
        ].join("\n"),
    },
    analyst: {
        agent: "oct-junior",
        instruction: [
            ...
            "",
            "## Workflow",
            "1. Understand the data and analysis goal → analysis plan",
            "2. Process and analyze data using sound statistics → analysis results",
            "3. Report uncertainties, assumptions, methodology → findings report",
            "",
            "## Rules",
            "- Report uncertainties, assumptions, and methodology behind every result",
            "- Focus on analysis and findings, not figure design",
        ].join("\n"),
    },
    visualizer: {
        agent: "oct-junior",
    ...
    author: {
        ...
        instruction: [
            ...
            "- Keep notation and terminology consistent (LaTeX where appropriate)",
        ].join("\n"),
    },
    fantast: {
