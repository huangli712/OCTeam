 ...
 * edit (write-capable executors); oct-oracle, oct-explore,
 * oct-multimodal-looker, and oct-ultrabrain deny edit/task/bash/webfetch
 * (fully read-only); oct-librarian denies edit/task/bash but allows
