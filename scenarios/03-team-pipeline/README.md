...
```text
执行 scenarios/03-team-pipeline/README.md「场景 1」的完整闭环并自动评判。
...
6. 运行：bun scenarios/03-team-pipeline/check-math-gaussian-integral.ts <run_dir>
...
```text
执行 scenarios/03-team-pipeline/README.md「场景 2」的完整闭环并自动评判。
...
4. team_results 轮询至 master 收到汇总
5. 定位 <run_dir>
6. 运行：bun scenarios/03-team-pipeline/check-physics-pendulum.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
...
```text
执行 scenarios/03-team-pipeline/README.md「场景 3」的完整闭环并自动评判。
...
6. 运行：bun scenarios/03-team-pipeline/check-coding-fib-tdd.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
...
```text
执行 scenarios/03-team-pipeline/README.md「场景 4」的完整闭环并自动评判（挑战级：8 段串行，约 60 min）。
...
6. 运行：bun scenarios/03-team-pipeline/check-physics-md-pipeline.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
