...
```text
执行 scenarios/09-team-tollgate/README.md「场景 1」的完整闭环并自动评判。
...
6. 运行：bun scenarios/09-team-tollgate/check-math-fast-pow.ts <run_dir>
...
```text
执行 scenarios/09-team-tollgate/README.md「场景 2」的完整闭环并自动评判。
...
5. 定位 <run_dir>
6. 运行：bun scenarios/09-team-tollgate/check-physics-verlet.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
...
```text
执行 scenarios/09-team-tollgate/README.md「场景 3」的完整闭环并自动评判。
...
4. team_results 轮询至 master 收到汇总
5. 定位 <run_dir>
6. 运行：bun scenarios/09-team-tollgate/check-coding-reverse-str.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
...
```text
执行 scenarios/09-team-tollgate/README.md「场景 4」的完整闭环并自动评判（挑战级：6 成员、3 门串行 V&V）。
...
6. 运行：bun scenarios/09-team-tollgate/check-physics-heat-vv.ts <run_dir>
7. 按退出码报告：0 = PASS，1 = FAIL，2 = 用法/IO 错误
